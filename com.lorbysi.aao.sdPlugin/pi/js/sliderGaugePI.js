function SliderGaugePI(inContext, inStreamDeckVersion, inPluginVersion) {
    var instance = this;
    ...
    var cnt = "\
			...
			<div>\
				...
				<div class='sdpi-item'> \
					<div class='sdpi-item-label'>X Multiplier</div> \
					<input type='number' id='xmultiplier'> \
				</div> \
				<div class='sdpi-item'> \
					<div class='sdpi-item-label'>Y Multiplier</div> \
					<input type='number' id='ymultiplier'> \
				</div> \
				<div class='sdpi-item'> \
					<div class='sdpi-item-label'>X Offset</div> \
					<input type='number' id='xslideoffset'> \
				</div> \
				<div class='sdpi-item'> \
					<div class='sdpi-item-label'>Y Offset</div> \
					<input type='number' id='yslideoffset'> \
				</div> \
               <div class='sdpi-item'> \
			...
			<div>\
				...
				<div class='sdpi-item'> \
				    <div class='sdpi-item-label'></div> \
					<button class='sdpi-item-value' id='slidefilepickclick'>Upload Sliding</button> \
					<button id='slidefileclear'>Clear</button> \
				</div> \
				<div class='sdpi-item'> \
				    <div class='sdpi-item-label'></div> \
    ...
    colStr = settings["ymultiplier"];
	if (colStr && colStr.length > 0){
		document.getElementById('ymultiplier').value = colStr;
	} else {
      document.getElementById('ymultiplier').value = 0.0;
    }

    colStr = settings["xslideoffset"];
	if (colStr && colStr.length > 0){
		document.getElementById('xslideoffset').value = colStr;
	} else {
      document.getElementById('xslideoffset').value = 0.0;
    }

    colStr = settings["yslideoffset"];
	if (colStr && colStr.length > 0){
		document.getElementById('yslideoffset').value = colStr;
	} else {
      document.getElementById('yslideoffset').value = 0.0;
    }
	...
	document.getElementById('slidefilepickclick').addEventListener('click', slidefilepickClicked);
	...
	document.getElementById('slidefileclear').addEventListener('click', slidefileclearClicked);
    ...
    function valuesChanged(inEvent) {
       ...
       if (vvarStr.length > 0){
		...
		settings["xmultiplier"] = document.getElementById('xmultiplier').value;
		settings["ymultiplier"] = document.getElementById('ymultiplier').value;
		settings["xslideoffset"] = document.getElementById('xslideoffset').value;
		settings["yslideoffset"] = document.getElementById('yslideoffset').value;
	...
	function slidefilepickClicked(inEvent) {
		settingsProperty = 'slideimg';
	    document.getElementById('filepicker').click();
    }
	...
	function slidefileclearClicked(inEvent) {
		settings["slideimg"] = '';
    }
