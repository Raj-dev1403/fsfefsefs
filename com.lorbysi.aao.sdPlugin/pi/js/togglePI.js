function TogglePI(inContext, inStreamDeckVersion, inPluginVersion) {
    var instance = this;
    ...
    var cnt = "<div class='sdpi-item'> \
			   ...
			   <div class='sdpi-item'> \
					<div class='sdpi-item-label'>Read</div> \
	...
	if (evtStr && evtStr.length > 0){
      ...
      document.getElementById('evttype').value = "(>K:";
    }
    ...
    function valuesChanged(inEvent) {
	   ...
	   let vvarStr = document.getElementById('simvar').value.replace(/·/g, ' ');
	   if (vvarStr.length > 0){
